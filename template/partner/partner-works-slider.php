...
<section class="p-partner-works" id="works">
    ...
    <div class="p-partner-works__slider-wrap">
        ...
        <!-- ナビ矢印（オレンジ円・三角形） -->
        <button type="button" class="p-partner-works__nav p-partner-works__nav--prev" aria-label="前へ"></button>
        <button type="button" class="p-partner-works__nav p-partner-works__nav--next" aria-label="次へ"></button>
    </div>
