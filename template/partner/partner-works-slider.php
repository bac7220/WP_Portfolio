<section class="p-partner-works" id="works">
    <div class="p-partner-works__inner">
        <div class="p-partner-works__section-title">
            <span class="p-partner-works__section-title-en">WORKS</span>
            <h2 class="p-partner-works__title">WORKS</h2>
        </div>
        <p class="p-partner-works__lead">これまでの制作実績・担当領域の一部をご紹介します。</p>
    </div>
            ...
            <ul class="swiper-wrapper">
                ...
                if ($works_query->have_posts()):
                    while ($works_query->have_posts()):
                        ...
                        // Get category label from ACF or fallback
    ...
    <div class="p-partner-works__inner">
        <div class="p-partner-works__footer">
            <a href="<?php echo esc_url(get_post_type_archive_link('works')); ?>" class="p-partner-works__more-link">
                もっと見る
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4.5 3.5L11.5 3.5V10.5" stroke="currentColor" stroke-width="1.5"/><path d="M11 4L4 11" stroke="currentColor" stroke-width="1.5"/></svg>
            </a>
        </div>
    </div>
</section>
